...
@section('content')
    <div class="container-fluid py-2">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h5 class="fw-bold text-body mb-0"><i class="fas fa-map-marker-alt me-2 text-primary"></i> Master Lokasi Gudang
            </h5>
                        ...
                        <thead class="border-bottom border-secondary-subtle">
                            <tr>
                                ...
                                <th class="py-3 text-uppercase small fw-bold text-body-secondary"
                                    style="letter-spacing: 0.5px;">Nama Lokasi / Rak</th>
                                <th width="20%"
                        ...
                        <tbody>
                            @forelse($locations as $index => $location)
                                <tr>
                                    ...
                                    <td class="fw-bold text-body">{{ $location->name }}</td>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content border-0 shadow">
                                            <div class="modal-header border-bottom border-secondary-subtle">
                                                <h5 class="modal-title fw-bold text-body">Edit Lokasi Gudang</h5>
                                            ...
                                            <form action="/locations/{{ $location->id }}" method="POST">
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        <label class="form-label text-body fw-semibold">Nama Lokasi / Rak <span
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="text-center py-5">
                                        ...
                                        <h6 class="fw-bold text-body mb-1">Gudang Belum Diatur</h6>
                                        <p class="text-body-secondary small mb-0">Belum ada lokasi penyimpanan yang terdaftar.
                                            Klik tombol di atas untuk menambah.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
    ...
    <div class="modal fade" id="addLocationModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                <div class="modal-header border-bottom border-secondary-subtle">
                    <h5 class="modal-title fw-bold text-body">Tambah Lokasi Baru</h5>
